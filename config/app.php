...
return [
    ...
    'App' => [
        'namespace' => 'App',
        'titleFull' => env('APP_TITLE_FULL', 'Unnamed bandportal'),
        'titleShort' => env('APP_TITLE_SHORT', 'Unnamed bandportal'),
